...
#| fig.alt: >
#|   Diagram showing the full path from R to C++ for the FIMS
#|   maturity module.
...
#| fig.alt: >
#|   Diagram showing the maturity module path from R to
#|   Rcpp, including the LogisticMaturityInterface and
#|   LogisticMaturity classes with shared parameters.
...
#| fig.alt: >
#|   Diagram showing the maturity module path from R and
#|   Rcpp into the fims::LogisticMaturity class and the
#|   fims::Information object using shared pointers.
...
#| fig.alt: >
#|   Diagram showing the maturity module path from R
#|   through Rcpp to fims::LogisticMaturity, including
#|   shared pointers, the evaluate(x) method, and the
#|   fims::Information object.
...
#| fig.alt: >
#|   Diagram showing the maturity module inheritance
#|   structure, where fims::LogisticMaturity inherits
#|   from fims::MaturityBase and is linked to
#|   fims::Population through a shared maturity pointer.
...
#| fig.alt: >
#|   Diagram showing how maturity models are stored in
#|   fims::Information as a map of IDs to shared pointers,
#|   and how the selected maturity model is retrieved and
#|   linked to fims::Population.
...
#| fig.alt: >
#|   Diagram showing how maturity and population objects
#|   are stored in fims::Information using IDs and shared
#|   pointers, and how fims::Population retrieves the
#|   linked maturity model for evaluation.
...
#| fig.alt: >
#|   Diagram showing how both maturity and population
#|   objects are registered in fims::Information using
#|   ID to shared pointer maps, enabling linkage between
#|   fims::Population and the selected maturity model.
...
#| fig.alt: >
#|   Diagram showing how fims::Information iterates over
#|   populations and assigns the selected maturity model
#|   to fims::Population, highlighted by the red circle
#|   marking the shared maturity pointer used during
#|   evaluation.
knitr::include_graphics("figures/fims-path-maturity-8.png")
```
