...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f49a9c68410>, x, y, z)
...
```
    ...
    ##   mean(x) 423.439 430.7535 437.0124 434.2445 442.0285   512.255   100
    ##  meanC(x) 372.125 372.7350 485.8319 373.9070 384.1910 11153.105   100
