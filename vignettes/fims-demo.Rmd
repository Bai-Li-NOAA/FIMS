...
updated_configurations <- default_configurations_unnested |>
  ...
  updated_configurations |> knitr::kable()
...
default_parameters_unnested |> knitr::kable()
```
...
```{r fit-plot-biomass}
#| fig.alt: >
#|   Plot of spawning biomass for each sensitivty model.
