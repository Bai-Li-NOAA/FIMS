...
namespace fims
{
  ...
  public:
    ...
    static uint32_t id_g; /*!< reference id for vector object*/
    uint32_t id_m;        /*!< unique identifier assigned for all fims vector objects */
    // Constructors
    ...
    /**
     * @brief Returns the unique identifier for this vector object.
     *
     * @return uint32_t
     */
  ...
  template <typename Type>
  uint32_t fims::Vector<Type>::id_g = 1; /*!< reference id for vector object*/
  /**
