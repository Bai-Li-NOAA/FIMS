...
```
    ...
    ## ℹ Total run time was 1.25288 minutes
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.8.1
    ## ℹ Total run time was 1.23214 minutes
    ## ℹ Number of parameters: fixed_effects=77, random_effects=0, and total=77
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.8.1
    ## ℹ Total run time was 1.22659 minutes
    ## ℹ Number of parameters: fixed_effects=77, random_effects=0, and total=77
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.8.1 ℹ Total run time was 10.56069 seconds ℹ Number of
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.8.1 ℹ Total run time was 1.00621 minutes ℹ Number of
    ## parameters: fixed_effects=77, random_effects=0, and total=77 ℹ Maximum
