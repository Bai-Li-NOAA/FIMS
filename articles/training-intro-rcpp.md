...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f4f8e5d2530>, x, y, z)
...
```
    ...
    ##   mean(x) 417.809 432.0615 438.7303 436.9950 443.8835   518.737   100
    ##  meanC(x) 371.764 372.2800 482.2567 373.0715 381.0710 10991.747   100
