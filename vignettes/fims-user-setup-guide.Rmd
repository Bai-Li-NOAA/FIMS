...
<details>
<summary> 🛠️ Troubleshooting and Technical Support (Click to expand)</summary>

- If the instructions above do not work, please visit the FIMS [discussion page](https://github.com/orgs/NOAA-FIMS/discussions/1073) to see known issues and documented solutions. If you encounter a new error, feel free to post it there for technical assistance. Below is a scrollable (but not searchable) preview of the discussion page.

<p align="center">
  <iframe src="https://github.com/orgs/NOAA-FIMS/discussions/1073" 
          width="100%" 
          height="500px" 
