...
```
    ...
    ## ℹ Total run time was 1.20406 minutes
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.7.1
    ## ℹ Total run time was 1.21598 minutes
    ## ℹ Number of parameters: fixed_effects=77, random_effects=0, and total=77
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.7.1
    ## ℹ Total run time was 1.23201 minutes
    ## ℹ Number of parameters: fixed_effects=77, random_effects=0, and total=77
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.7.1 ℹ Total run time was 10.02644 seconds ℹ Number of
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.7.1 ℹ Total run time was 59.46415 seconds ℹ Number of
    ## parameters: fixed_effects=77, random_effects=0, and total=77 ℹ Maximum
