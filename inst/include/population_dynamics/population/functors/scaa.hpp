 ...
 *
 */
#ifndef FIMS_POPULATION_DYNAMICS_SCAA_HPP
#define FIMS_POPULATION_DYNAMICS_SCAA_HPP
...
/**
 * @brief Statistical Catch-at-Age Population class. Contains subpopulations
 * that are divided into generic partitions (eg. sex, area).
 */
template <typename Type>
struct SCAA : public fims_model_object::FIMSObject<Type> {
